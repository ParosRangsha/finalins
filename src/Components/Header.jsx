...
const Header = () => {
  ...
  return (
    <>
      ...
      {
        showuser &&
        <div className="absolute w-[200px] h-[250px] bg-[#ddd] left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]">
          <input type="text" placeholder='User ID' onChange={(e)=>setUser(e.target.value)}/>
